...
#define GPIOB_MOTOR0_SENSE       0
#define GPIOB_MOTOR1_SENSE       1
#define GPIOB_MOTOR_STANDBY      2
...
/*
 * Port B setup:
 * PB0  - GPIOB_MOTOR0_SENSE        (analog input)
 * PB1  - GPIOB_MOTOR1_SENSE        (analog input)
 * PB2  - GPIOB_MOTOR_STANDBY       (output pushpull)
 ...
 */
#define VAL_GPIOB_MODER    (PIN_MODE_ANALOG(GPIOB_MOTOR0_SENSE) | \
                            PIN_MODE_ANALOG(GPIOB_MOTOR1_SENSE) | \
                            PIN_MODE_OUTPUT(GPIOB_MOTOR_STANDBY) | \
