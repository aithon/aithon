...
Source: AithonLibrary\*; DestDir: {app}\AithonLibrary; Flags: ignoreversion recursesubdirs createallsubdirs sortfilesbyextension sortfilesbyname; Components: main
