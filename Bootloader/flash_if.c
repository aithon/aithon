...
{
  uint32_t UserStartSector = FLASH_Sector_2, i = 0;
...
{
  uint32_t UserStartSector = FLASH_Sector_2;
...
{
  __IO uint32_t UserStartSector = FLASH_Sector_2, UserWrpSectors = OB_WRP_Sector_1;
